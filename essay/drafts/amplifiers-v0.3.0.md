...
**Version:** 0.3.0-draft (complete, with quantum boundary-sensing layer)  
...
### 4.4 Quantum boundary sensing

A rapidly developing branch of modern physics has placed boundary sensing on explicitly quantum-mechanical foundations, through the framework of non-Hermitian Hamiltonians and exceptional points.

When a quantum system exchanges energy with its environment — through engineered loss, gain, or dissipative mode coupling — its effective description becomes non-Hermitian: the eigenvalues of the governing operator acquire imaginary parts, representing decay or amplification. At certain parameter values, two or more eigenvalues and their corresponding eigenstates coalesce simultaneously — a spectral singularity known as an *exceptional point* (EP). Near an EP, the system's response to perturbations is dramatically amplified: a small change in an external parameter produces a disproportionately large shift in the eigenvalue spectrum. This has generated intense interest in EP-enhanced sensing across photonic, acoustic, electronic, and quantum platforms.[^13]

The connection to the sentinel framework is structural. Near an exceptional point, the system's spectral "stiffness" vanishes — the eigenvalues become degenerate and the eigenstates collapse onto each other. This is, in the non-Hermitian setting, the analogue of the eigenvalue approaching zero in the classical bifurcation picture of Section 3. The gain rises; the invertibility degrades. The system becomes exquisitely sensitive to perturbations but loses the capacity to distinguish their origin. Recent work has established that useful non-Hermitian sensing can occur near but not necessarily exactly at an exceptional point — the optimal operating point balances amplification against noise, much as the controlled sentinel concept of Section 5 proposes.

Trapped-ion systems have become a leading platform for this physics. EP3 behaviour — the coalescence of three eigenvalues and eigenstates — has been observed in a dissipative trapped-ion system using engineered loss channels in a ¹⁷¹Yb⁺ ion. Programmable simulation of higher-order EPs, including the coalescence of second-order EPs into a fourth-order EP, has been demonstrated with controllable dissipation and coherent drives. These experiments show that the boundary-sensing paradigm can be implemented with high-precision quantum control, going well beyond generic analogy.[^14]

It is important, however, to distinguish two kinds of boundary sensitivity that arise in trapped-ion systems, because they are related but not identical:

In one class of examples, a trapped-ion Coulomb crystal near a structural or thermal instability — approaching the transition from crystalline order to a liquid-like or cloud-like state of the non-neutral plasma — shows large structural response to small perturbations. A perturbation that would be negligible deep in the ordered phase can, near the boundary, trigger a disproportionate rearrangement. Here the physics is that of a classical many-body phase boundary: the crystal's "stiffness" decreases as the melting transition is approached, in direct analogy to the storm glass near its solubility limit.

In the other class, the boundary is spectral rather than structural: an engineered non-Hermitian effective Hamiltonian exhibits an exceptional point, and the sensitivity enhancement arises from the coalescence of eigenvalues in the open-system dynamics. Recent proposals for driven-dissipative ion arrays with non-Hermitian point-gap topology and directional amplification exploit exactly this mechanism for weak-force sensing.[^15]

These are analogous but non-identical mechanisms of amplified response at a boundary. Together, they clarify that quantum boundary sensing is not a single phenomenon but a family of effects united by the principle that response is amplified where a system approaches a regime boundary — whether that boundary is structural (crystal melting), spectral (exceptional point), or thermodynamic (phase transition). The 19th-century storm glass, the trapped-ion Coulomb crystal near melting, and the dissipative ion system near an EP all inhabit the same epistemological category: they are sentinels of proximity, not meters of state.

### 4.5 Precision measurement near stability boundaries

A brief, complementary connection to the *other* side of near-boundary physics in trapped ions — the side that deliberately avoids boundaries.
...
The metrologist's everyday practice thus already contains both sides of the sentinel problem: the need to stay away from boundaries for state measurement, and the enhanced sensitivity that arises when boundaries are approached. What the sentinel framework adds is the recognition that the second regime is not merely a nuisance to be avoided but a distinct measurement paradigm with its own uses.[^16]
...
[^13]: For a recent perspective on non-Hermitian physics across quantum platforms, emphasising exceptional points, topology, and sensing, see Y. Wu et al., "Non-Hermitian physics in the quantum regime," *National Science Review* 12 (2025): nwaf144. For a comprehensive review of exceptional points at the nanoscale, see A. Li et al., "Exceptional points and non-Hermitian photonics at the nanoscale," *Nature Nanotechnology* 18 (2023): 706–720. On the controversy surrounding EP-enhanced sensing and the role of noise, see H.-K. Lau and A. A. Clerk, "Fundamental limits and non-reciprocal approaches in non-Hermitian quantum sensing," *Nature Communications* 9 (2018): 4320.

[^14]: Y.-Y. Chen et al., "Quantum tomography of a third-order exceptional point in a dissipative trapped ion," *Nature Communications* 16 (2025): 7487 (EP3 in ¹⁷¹Yb⁺). Y. Li et al., "Programmable simulation of high-order exceptional point with a trapped ion," *Quantum Frontiers* (2025), arXiv:2412.09776 (coalescence of EP2s into EP4).

[^15]: The distinction between structural/thermal boundaries (Coulomb crystal near melting) and spectral/open-system boundaries (exceptional points in engineered non-Hermitian dynamics) is important. A Coulomb crystal is already a non-neutral plasma in a strongly coupled, ordered regime; the transition is from crystalline order to a liquid-like or cloud-like state of the same non-neutral plasma, not from "crystal" to "plasma" as though non-neutrality appeared only after the transition.

[^16]: For the physics of trapped ions near stability boundaries, see D. Leibfried, R. Blatt, C. Monroe, and D. Wineland, "Quantum dynamics of single trapped ions," *Reviews of Modern Physics* 75 (2003): 281–324. The characterisation of precision metrology as a programme for "maintaining distance from regime boundaries" is, again, ours.
...
- Chen, Y.-Y. et al. (2025). "Quantum tomography of a third-order exceptional point in a dissipative trapped ion." *Nature Communications* 16: 7487.
...
- Li, Y. et al. (2025). "Programmable simulation of high-order exceptional point with a trapped ion." *Quantum Frontiers*. arXiv:2412.09776.
