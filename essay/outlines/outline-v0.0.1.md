...
## Structural Outline for Sail Essay (v0.0.1-outline)
...
**~1200 words. Register: expository with essayistic framing.**
...
| 1. The displacement puzzle | ~1200 | Expository + essayistic framing |
...
| 5. The controlled sentinel: a proposal | ~1500 | Essayistic, returning to 'we' |
